...
module.exports.makeHtmlFiles = async (outputDirPath, dataDirPath, templateDirPath, backup) => {
      ...
      partsVariations.map(async partsVariation => {
        ...
        if (filename.match(/^151_.*_sideMenu_a00_001$/)) {
          for (const lv of [1, 2, 3]) {
            ...
            await fs.outputFile(_outputfilePath, _html);
          }
