...
module.exports.createUnittestMD = (commentBlockName, commentBlockCategory, htmlDirName) => {
  return new Unittest(commentBlockName, commentBlockCategory, htmlDirName);
}
...
class Unittest extends AbstractAigisMarkdown {
  ...
  setAigisMarkdown(functionKey, blockCategory) {
    ...
    const designBlockKeys = Object.keys(buddyPartsTestcases).filter(buddyPartsDesignKey => {
      return buddyPartsTestcases[buddyPartsDesignKey]['functionBlock'] === functionKey;
    })
